...
import { BASE_GOERLI, AVALANCHE_FUJI, getChainName } from "config/chains";
      ...
      <div className="page-not-found-container">
        <div className="page-not-found">
          ...
          <p className="go-back">
            ...
            <div className="clickable underline" onClick={() => switchNetwork(BASE_GOERLI, active)}>
              {getChainName(BASE_GOERLI)}
            </div>
          </p>
        </div>
      </div>
