        ...
        <div className="section-title-block">
          ...
          <div className="section-title-content">
            ...
            <div className="Page-description">
              <Trans>Job openings at EDDX.</Trans>
            </div>
          </div>
        </div>
...
function NoJob() {
  return (
    <Card title={t`No open positions at EDDX currently`}>
      <div className="body-para">
        <p className="subheading">
          <Trans>
            EDDX is not actively looking for new hires at the moment. However, if you think you can contribute to the
            project, please email <ExternalLink href="mailto:jobs@eddx.io">jobs@eddx.io</ExternalLink>.
          </Trans>
        </p>
      </div>
    </Card>
...
//     <ul>
//       <li>Work closely with the EDDX team on the EDDX front-end website.</li>
...
//       </ul>
//       <p>The salary is 60,000 to 120,000 USD + 1,000 to 3,000 EDDX a year.</p>
//       <p className="jobs-contact">
//         If the job suits you, please get in touch with{" "}
//         <a target="_blank" href="mailto:jobs@eddx.io" rel="noopener noreferrer">
//           jobs@eddx.io
//         </a>{" "}
