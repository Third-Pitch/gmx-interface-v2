      ...
      <Menu>
        ...
        <Menu.Items as="div" className="TradeDropdown-options  menu-items">
          <Menu.Item>
            ...
            >
              <img src={getIcon("common", "eddxOutline")} alt="EDDX V1" className="TradeDropdown-option-icon" />
              <div className="TradeDropdown-option-label">EDDX V1</div>
            </HeaderLink>
          </Menu.Item>
          ...
          <Menu.Item>
            <HeaderLink
              ...
              showRedirectModal={showRedirectModal}
            >
              <img src={getIcon("common", "eddxOutline")} alt="EDDX V2" className="TradeDropdown-option-icon" />
              <div className="TradeDropdown-option-label">EDDX V2</div>
            </HeaderLink>
          </Menu.Item>
        </Menu.Items>
      </Menu>
