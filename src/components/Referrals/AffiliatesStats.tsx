...
import { BASE, AVALANCHE, AVALANCHE_FUJI, getExplorerUrl } from "config/chains";
                                ...
                                renderContent={() => (
                                  <div>
                                    <Trans>
                                      ...
                                      {chainId === AVALANCHE ? "Base" : "Avalanche"}, you will not receive rebates
                                      there.
                                      <br />
                                      <br />
                                      Switch your network to create this code on{" "}
                                      {chainId === AVALANCHE ? "Base" : "Avalanche"}.
                                    </Trans>
                                  </div>
                                )}
                              />
                                ...
                                renderContent={() => (
                                  <div>
                                    <Trans>
                                      ...
                                      {chainId === AVALANCHE ? "Base" : "Avalanche"}, you will not receive rebates
                                      from traders using this code on {chainId === AVALANCHE ? "Base" : "Avalanche"}
                                      .
                                    </Trans>
                                  </div>
                                )}
